public class RollsRoyce extends Car{
    ...
    public RollsRoyce(String sound, double gasConsumption, String name, String model, String brand, int year, String location, double gas) {
    ...
    public void calculateGasUsed(double distance, double gasConsumption) {
